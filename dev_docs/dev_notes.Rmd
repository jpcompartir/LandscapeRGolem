...
ui <- semanticPage(
  ...
  div(
    class = "code_block",
    div(class = "code_header", "Code Block 1", onclick = "toggleCode('code1')"),
    div(class = "hidden_code", verbatimTextOutput("code1"))
  ),
  div(
    class = "code_block",
    div(class = "code_header", "Code Block 2", onclick = "toggleCode('code2')"),
    div(class = "hidden_code", verbatimTextOutput("code2"))
  )
)
...
server <- function(input, output, session) {
  ...
  output$code2 <- renderPrint({
    cat("# This is a code block 2\nprint('Goodbye, world!')")
  })

  runjs("
    function toggleCode(id) {
      var codeBlock = document.getElementById(id).parentNode;

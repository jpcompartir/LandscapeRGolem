...
golem::fill_desc(
  ...
  author_last_name = "Penzer", # Your Last Name
  author_email = "jackpenzer@sharecreative.com", # Your Email
...
usethis::use_mit_license("Jack Penzer") # You can set another license here
usethis::use_readme_rmd(open = FALSE)
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Jack Penzer")

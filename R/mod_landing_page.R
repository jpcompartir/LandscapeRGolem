...
<h1>Welcome to <span style='color: #ff7518;'>LandscapeR!</span></h1>
    ...
    shiny::fluidRow(
      shiny::column(3,
                  ...
                  <p>Head over to the Survey Landscape tab, use your mouse or trackpad to select regions of the conversation landscape, and watch the data table populate to the right. You cannot render any of the exploratory charts until you have selected some data. Use plotly's lasso or box selection tools to highlight interesting areas of the map. Once you've highlighted some data, you can delete it by clicking the delete button which appears, or label it by typing a label and clicking the label button that appears. <br> <br>
                  "),
                  shiny::tagList(
      ...
      shiny::column(3,
                    shiny::HTML("<h2><b>Downloading Data</b></h2>
                               <p>You can download all of the remaining data,or only the selected data using the download widgets in the Survey Landscape tab. You can download your labelled data by visiting the Labelled Data tab. Any data you delete will by definition not be selected, and will download only when you 'download all data'.</p>")),
      shiny::column(6,
                    shiny::HTML("<h2><b>Viewing Summary Plots</b></h2>
                      ...
                      <li><b>Distributions Tab</b> is for looking at your selection's volume over time, sentiment distribution, and frequent words.</li>

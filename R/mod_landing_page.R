...
<h1>Welcome to <span style='color: #ff7518;'>LandscapeR!</span></h1>
                  ...
                  <br>
                  <p><b>If you are familiar</b> with  <span style='color: #ff7518;'>LandscapeR</span>, you should <b>move directly</b> to the <b>Landscape tab</b> to start analysing your mapped conversation. If not: <a href='https://jpcompartir.github.io/LandscapeR/' target='blank'>click here</a>
                  </p>
                  "),
      ),
      shiny::column(
    ...
    shiny::fluidRow(
      ...
      shiny::column(
        ...
        shiny::HTML("<h2><b>Download</b></h2>
                               <p>You can download all of the remaining data, or only the selected data using the respective download widgets in the Landscape tab. You can download your labelled data by visiting the Labelled Data tab.</p>
